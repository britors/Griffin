...
export function ExportPanel() {
  const { selected, volumes, muted, solo, pitch, tempo, loopEnabled, loopStart, loopEnd } = usePlayer()
  ...
  const exportAudio = async () => {
    ...
    const options: AudioExportOptions = { stems, volumes, muted, solo, pitch, tempo, format: 'wav', ...(useLoop && loopEnabled ? { loop: { start: loopStart, end: loopEnd } } : {}) }
    try {
