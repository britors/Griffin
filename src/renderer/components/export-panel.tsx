...
export function ExportPanel() {
  ...
  const exportAudio = async () => {
    ...
    const options: AudioExportOptions = { stems, volumes, pans, equalizer, muted, solo, pitch, tempo, format: 'wav', sampleRate, bitDepth, requestId: nextRequestId, ...(useLoop && loopEnabled ? { loop: { start: loopStart, end: loopEnd } } : {}) }
    try {
